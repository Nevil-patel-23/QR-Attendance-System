...
@Route(value = "student/profile/password", layout = StudentLayout.class)
@PageTitle("Change Password")
@RolesAllowed("STUDENT")
public class StudentPasswordView extends VerticalLayout implements BeforeEnterObserver {

    public StudentPasswordView(ProfileService profileService) {
        setSpacing(true);
        setPadding(true);

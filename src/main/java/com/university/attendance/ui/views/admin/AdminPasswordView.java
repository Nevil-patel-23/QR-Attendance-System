...
@Route(value = "admin/profile/password", layout = AdminLayout.class)
@PageTitle("Change Password")
@RolesAllowed("ADMIN")
public class AdminPasswordView extends VerticalLayout implements BeforeEnterObserver {

    public AdminPasswordView(ProfileService profileService) {
        setSpacing(true);
        setPadding(true);
